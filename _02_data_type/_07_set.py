...
print("--- set ---")
st = {1,2,4,1,3,1,3,2,3,4,1,3,2,4,3,2,1}
print(st, type(st))

print("--- list -> set 변경 (중복 제거) ---")
lst = [1,2,4,1,3,1,3,2,3,4,1,3,2,4,3,2,1]
st2 = set(lst) # set 변경
print("st2: ", st2)
# print(st2[2]) # TypeError: 'set' object is not subscriptable
...
tpl = (1,2,3,4,1,3,2,3,4,1,3,2,4,3,2,1)
st3 = set(tpl)
print("st3: ", st3)
