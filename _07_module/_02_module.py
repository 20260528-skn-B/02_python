...
- 단, _, __ 로 시작하는 이름은 "내부용(private)"이라는 관례가 있음
    -> 외부에서 import 해서 사용하는 것을 지양함

- import * -> 모듈 내 모든 변수, 함수, 클래스 가져오기
           -> 단, _, __ 로 시작하는 변수, 함수, 클래스는 자동 제외
"""
...
# print("my_math.get_circle_area(10): ", my_math.get_cicle_area(10))
...
# print("pi: ", pi)
# print("x: ", x)
# print("get_circlel_area(10): ", get_cicle_area(10))
...
print("mm.pi: ", mm.pi)
print("mm.x: ", mm.x)
print("mm.get_circle_area(10): ", mm.get_cicle_area(10))
